...
public class TokenAuthenticationFilter extends OncePerRequestFilter {
    ...
    public TokenAuthenticationFilter(TokenService tokenService, AppUserRepository userRepository, AdminAccessService adminAccessService) {
