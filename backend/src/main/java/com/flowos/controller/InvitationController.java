...
import com.flowos.dto.InvitationDtos.CreateInvitationRequest;
import com.flowos.dto.InvitationDtos.InvitationResponse;
...
public class InvitationController {
    ...
    public InvitationResponse create(@Valid @RequestBody CreateInvitationRequest request) {
        ...
        auditService.record(user.getOrganization(), user, "invitation.created", "invitation", saved.getId(), "Invitation created for " + email + " as " + saved.getRole());
        return new InvitationResponse(saved, invitationLink(request.appUrl(), saved.getToken()));
    }

    private void requireAdmin(com.flowos.model.AppUser user) {
